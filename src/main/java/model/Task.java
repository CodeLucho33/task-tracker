...
public class Task {
    ...
    private String status; // Valores posibles: "todo", "in-progress", "done"
    ...
    // toString() para una visualización legible
    @Override
    ...
    // equals() y hashCode() para comparar objetos y usarlos en colecciones
    @Override
